export const elements = {
  ...
  prodContainer: document.getElementById('production-diagram'),
  modeToggle: document.getElementById('mode-toggle'),
  labelDemo: document.getElementById('label-demo'),
  labelProd: document.getElementById('label-prod'),
  ...
  continuousFlows: document.querySelectorAll('#diagram .continuous-flow'),
